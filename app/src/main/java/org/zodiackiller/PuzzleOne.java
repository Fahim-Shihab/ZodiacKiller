...
public class PuzzleOne extends AppCompatActivity{
    ...
    {
        try {
            re = (RelativeLayout) findViewById(R.id.puzzleone);

            LayoutInflater inflater = (LayoutInflater) PuzzleOne.this
            ...
            layout.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent mo) {
                    pwindo.dismiss();
                    Intent intent = new Intent(PuzzleOne.this, Scene1a.class);
                    startActivity(intent);
                    return true;
                }
            });
    ...
    public void onBackPressed() {
        Toast.makeText(PuzzleOne.this, "The countdown will still continue, solve the puzzle first", Toast.LENGTH_SHORT).show();
    }
}
