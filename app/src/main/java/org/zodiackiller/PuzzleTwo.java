...
public class PuzzleTwo extends AppCompatActivity{
    ...
    {
        try {
            re = (RelativeLayout) findViewById(R.id.puzzletwo);

            LayoutInflater inflater = (LayoutInflater) PuzzleTwo.this
            ...
            layout.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent mo) {
                    pwindo.dismiss();
                    Intent intent = new Intent(PuzzleTwo.this, Scene1a.class);
                    startActivity(intent);
                    return true;
                }
            });
    ...
    public void onBackPressed() {
        Toast.makeText(PuzzleTwo.this, "The countdown will still continue, solve the puzzle first", Toast.LENGTH_SHORT).show();
    }
}
