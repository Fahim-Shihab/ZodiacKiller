            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                if (Math.abs(e1.getY() - e2.getY()) > SWIPE_MAX_OFF_PATH) {
                    ...
                    if (e1.getY() - e2.getY() > SWIPE_MIN_DISTANCE) {
                        KillerFacePuzzle.moveTiles(context, KillerFacePuzzle.up, position);
                    } else if (e2.getY() - e1.getY() > SWIPE_MIN_DISTANCE) {
                        KillerFacePuzzle.moveTiles(context, KillerFacePuzzle.down, position);
                    }
                } else {
                    ...
                    if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE) {
                        KillerFacePuzzle.moveTiles(context, KillerFacePuzzle.left, position);
                    } else if (e2.getX() - e1.getX() > SWIPE_MIN_DISTANCE) {
                        KillerFacePuzzle.moveTiles(context, KillerFacePuzzle.right, position);
                    }
                }
